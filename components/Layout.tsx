        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white">
              ...
              <li><Link to="/become-supplier" className="hover:text-blue-200 transition-colors">Become a Supplier</Link></li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:ml-10 md:flex md:space-x-8">
                <Link to="/" className={`${isActive('/') ? 'border-[#003580] text-[#003580]' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium h-16`}>
                  Home
                </Link>
                <Link to="/my-bookings" className={`${isActive('/my-bookings') ? 'border-[#003580] text-[#003580]' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium h-16`}>
                  Manage Booking
                </Link>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link to="/my-bookings" className="flex items-center gap-2 text-sm font-bold text-slate-700 hover:text-[#003580] px-3 py-2 rounded-md hover:bg-slate-50 transition-colors">
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-slate-200">
            <div className="pt-2 pb-3 space-y-1">
              <Link to="/" onClick={() => setIsMenuOpen(false)} className="block pl-3 pr-4 py-3 border-l-4 border-[#003580] text-base font-medium text-[#003580] bg-blue-50">Home</Link>
