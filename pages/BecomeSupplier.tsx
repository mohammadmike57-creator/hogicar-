...
const BecomeSupplier: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 font-sans min-h-screen">
      <SEOMetadata
        title="Become a Supplier | Hogicar Partner Network"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden">
                  <div className="p-8 border-b border-slate-100">
                      <h2 className="text-2xl font-bold text-slate-800">Supplier Application</h2>
              ...
              <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-[#003580] p-6 rounded-xl shadow-sm text-white">
                      <h3 className="font-bold text-lg mb-2">Already a Supplier?</h3>
