...
import { CheckCircle, Shield, ChevronDown, Globe, ArrowRight, Award, MapPin } from 'lucide-react';
...
```
  ...
  <section className="bg-[#003580] pt-16 pb-14 text-center text-white">
    <div className="max-w-5xl mx-auto px-4">
      ...
      <p className="text-blue-100 mb-8">
        Compare prices from hundreds of car rental suppliers worldwide.
      </p>
  ...
  <section className="py-10 border-b">
    <div className="max-w-6xl mx-auto px-4 text-center mb-6">
      <h2 className="text-2xl font-bold">Trusted by leading suppliers</h2>
    </div>
  ...
  <section className="py-12 bg-slate-50">
    <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-4 gap-6">
      ...
      {content.features.slice(0,4).map(f => (
        <div key={f.id} className="bg-white rounded-xl p-6 border text-center">
