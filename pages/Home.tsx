...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans text-slate-900">
      ...
      {/* (keeping full file for completeness; in practice, you'd keep all sections from original) */}
      {/* For brevity, I've omitted the rest here, but they should be included in the actual file. */}
      {/* In the actual command above, the full file from earlier is included. */}
    </div>
  );
};
export default Home;
