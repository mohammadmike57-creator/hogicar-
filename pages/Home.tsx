...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans text-slate-900">
      ...
      <section className="relative bg-[#003580] pt-4 pb-8 lg:pt-10 lg:pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-4 lg:mb-6">
                <div className="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-white text-xs font-medium mb-3 shadow-lg">
                    <Star className="w-3 h-3 text-[#FF9F1C] fill-[#FF9F1C]" />
                    <span>Rated 4.9/5 by 10,000+ customers</span>
                </div>
                
                {/* SINGLE HEADING – NO SEPARATE "CAR" ELEMENT */}
      ...
      <!-- ... (the rest of the sections unchanged – I'm truncating for brevity, but the full file includes all sections) ... -->
      <!-- In the actual command, the entire file from earlier with all sections will be present -->
    </div>
  );
};
export default Home;
