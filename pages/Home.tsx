...
const Home: React.FC<HomeProps> = ({ seoConfig }) => {
  ...
  return (
    <div className="bg-white font-sans">
      ...
      {sections.benefits && (
          <section className="py-24 bg-[#003580] text-white overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 text-center md:text-left">
                    ...
                    <div className="hidden md:block pb-2">
                        <Link to="/about" className="group flex items-center gap-2 text-white font-black uppercase text-sm tracking-widest hover:text-accent transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {content.features.map((feature, i) => {
                        ...
                        return (
                            <div key={i} className="relative p-10 rounded-[2.5rem] bg-white/5 backdrop-blur-sm border border-white/10 shadow-2xl hover:bg-white/10 transition-all duration-500 group overflow-hidden">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-bl-[5rem] -mr-16 -mt-16 group-hover:bg-accent/10 transition-colors duration-500" />
                                <div className="relative z-10">
                                    <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-8 group-hover:bg-accent group-hover:text-white transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 text-white">
                                        <Icon className="w-8 h-8" />
                                    </div>
                                    <h3 className="text-xl font-black text-white mb-4 uppercase tracking-tight leading-none">{feature.title}</h3>
                                    <p className="text-blue-100/70 text-sm leading-relaxed font-bold">{feature.description}</p>
                                </div>
                            </div>
                        );
                    })}
